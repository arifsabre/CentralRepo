...
namespace ManufacturingManagement_V2.Reports {
    ...
    public class OrderFooter : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "ManufacturingManagement_V2.Reports.OrderFooter.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedOrderFooter : Component, ICachedReport {
        
        public CachedOrderFooter() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            OrderFooter rpt = new OrderFooter();
            rpt.Site = this.Site;
            return rpt;
        }
