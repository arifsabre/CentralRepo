...
namespace ManufacturingManagement_V2.Reports {
    ...
    public class LeaveSummaryRpt : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "ManufacturingManagement_V2.Reports.LeaveSummaryRpt.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedLeaveSummaryRpt : Component, ICachedReport {
        
        public CachedLeaveSummaryRpt() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            LeaveSummaryRpt rpt = new LeaveSummaryRpt();
            rpt.Site = this.Site;
            return rpt;
        }
