...
namespace ManufacturingManagement_V2.Reports {
    ...
    public class ReturnPFRpt : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "ManufacturingManagement_V2.Reports.ReturnPFRpt.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedReturnPFRpt : Component, ICachedReport {
        
        public CachedReturnPFRpt() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            ReturnPFRpt rpt = new ReturnPFRpt();
            rpt.Site = this.Site;
            return rpt;
        }
