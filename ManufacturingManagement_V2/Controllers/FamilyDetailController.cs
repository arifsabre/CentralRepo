...
namespace ManufacturingManagement_V2.Controllers
{
    public class FamilyDetailController : Controller
    {
        ...
        private FamilyDetailBLL bllObject = new FamilyDetailBLL();
        ...
        public ActionResult Index(int newempid = 0, string empname = "")
        {
            ...
            setViewData();
            List<FamilyDetailMdl> modelObject = new List<FamilyDetailMdl> { };
        ...
        public ActionResult CreateUpdate(int id = 0, string empid = "", int newempid = 0)
        {
            ...
            FamilyDetailMdl modelObject = new FamilyDetailMdl();
        ...
        // POST: /CreateUpdate
        [HttpPost]
        public ActionResult CreateUpdate(FamilyDetailMdl modelObject)
        {
        ...
        public ActionResult Details(int id = 0)
        {
            ...
            setViewData();
            FamilyDetailMdl modelObject = bllObject.searchObject(id);
            if (modelObject == null)
            {
                return HttpNotFound();
            }
