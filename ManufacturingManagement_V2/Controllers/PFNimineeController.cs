...
{
    public class PFNomineeController : Controller
    {
        clsCookie objCookie = new clsCookie();
        clsMyClass mc = new clsMyClass();
        private PFNomineeBLL bllObject = new PFNomineeBLL();
        ...
        public ActionResult Index(int newempid = 0, string empname = "")
        {
            ...
            setViewData();
            List<PFNomineeMdl> modelObject = new List<PFNomineeMdl> { };
        ...
        public ActionResult CreateUpdate(int id = 0, string empid = "", int newempid = 0)
        {
            ...
            setViewData();
            ViewBag.NomineeForList = new SelectList(mc.getNomineeForList(), "Value", "Text");
            ViewData["AddEdit"] = "Save";
            PFNomineeMdl modelObject = new PFNomineeMdl();
        ...
        // POST: /CreateUpdate
        [HttpPost]
        public ActionResult CreateUpdate(PFNomineeMdl modelObject)
        {
        ...
        public ActionResult Details(int id = 0)
        {
            ...
            setViewData();
            PFNomineeMdl modelObject = bllObject.searchObject(id);
            if (modelObject == null)
            {
                return HttpNotFound();
            }
