...
{
    public class B_Working_Hours_lessthan_830Controller : Controller
    {
        //
        // GET: /B_Working_Hours_lessthan_830/
        ...
        [HttpPost]
        public ActionResult Get_B_Lessthan830(rptOptionMdl rptOption)
        {
            //[100144]
            if (objCookie.checkSessionState() == false) { return RedirectToAction("LoginUser", "Login"); };
            setViewData();
            ...
            {
                string reporturl = "B_Working_Hours_lessthan_830/Get_B_Lessthan830_File";
            ...
            return RedirectToAction("Get_B_Lessthan830_File", new { dtfrom = rptOption.DateFrom, dtto = rptOption.DateTo, compcode = rptOption.CompCode, grade = rptOption.Grade });
        }
        public ActionResult Get_B_Lessthan830_File(DateTime dtfrom, DateTime dtto, int compcode, string grade)
        {
            //[100144]
            ...
            rptDoc.Load(System.IO.Path.Combine(Server.MapPath("~/Reports"), "B_LessThan_830_Hours_Work.rpt"));//TestXCrystalReport1
            setLoginInfo(rptDoc);
