...
namespace ManufacturingManagement_V2.Controllers
{
    public class ExperienceDetailController : Controller
    {
        ...
        private ExperienceDetailBLL bllObject = new ExperienceDetailBLL();
        ...
        public ActionResult Index(int newempid = 0, string empname = "")
        {
            ...
            //
            setViewData();
            List<ExperienceDetailMdl> modelObject = new List<ExperienceDetailMdl> { };
        ...
        public ActionResult CreateUpdate(int id = 0, string empid = "", int newempid = 0)
        {
            ...
            ExperienceDetailMdl modelObject = new ExperienceDetailMdl();
        ...
        // POST: /CreateUpdate
        [HttpPost]
        public ActionResult CreateUpdate(ExperienceDetailMdl modelObject)
        {
        ...
        public ActionResult Details(int id = 0)
        {
            ...
            //
            setViewData();
            ExperienceDetailMdl modelObject = bllObject.searchObject(id);
            if (modelObject == null)
            {
                return HttpNotFound();
            }
