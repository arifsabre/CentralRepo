...
{
    public class ProfitNdLossReportController : Controller
    {
        ...
        [HttpPost]
        public ActionResult DisplayProfitNdLossReport(rptOptionMdl rptOption)
        {
            //[100080]
            if (objCookie.checkSessionState() == false) { return RedirectToAction("LoginUser", "Login"); };
            setViewData();
            ...
            {
                string reporturl = "ProfitNdLossReport/GetReportHTML";
        ...
        public ActionResult GetReportHTML(int compcode, string finyear, DateTime vdate)
        {
            ...
            ds = rptBLL.GetProfitAndLossReportHtml(compcode, finyear, vdate);
            ...
            sbHeader.Append("<b><u>Profit and Loss Statement</u></b>");
            sbHeader.Append("</div>");
            //report filters
            ...
            sb.Append("<thead>");
            sb.Append("<tr>");
            sb.Append("<th style='width:225;'>Particulars</th>");//loss side
            sb.Append("<th style='width:150px;text-align:right;'>Amount(DR)</th>");//dramt
            sb.Append("<th style='width:225;'>Particulars</th>");//profit side
        ...
        public ActionResult getProfitNdLossReport(int compcode, DateTime vdate, string finyear="")
        {
            //[100080]
            if (mc.isValidToDisplayReport() == false)
            {
            ...
            //
            ProfitNdLossRptBLL rptBLL = new ProfitNdLossRptBLL();
            CrystalDecisions.CrystalReports.Engine.ReportDocument rptDoc = new CrystalDecisions.CrystalReports.Engine.ReportDocument();
            Reports.dsReport dsr = new Reports.dsReport();
            rptDoc.Load(System.IO.Path.Combine(Server.MapPath("~/Reports"), "ProfitNdLoss.rpt"));
            rptBLL.prepareProfitNdLoss(vdate, dsr.Tables["dtTrialBalance"], dsr.Tables["dtDebit"], dsr.Tables["dtCredit"], dsr.Tables["dtPnL"], compcode, finyear);
            //
            ...
            txtRptHead.Text = "Profit & Loss as on Date: " + mc.getStringByDate(vdate)+", Financial Year: "+finyear;
            setLoginInfo(rptDoc);
