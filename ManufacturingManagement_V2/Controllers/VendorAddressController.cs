...
namespace ManufacturingManagement_V2.Controllers
{
    public class VendorAddressController : Controller
    {
        ...
        private VendorAddressBLL bllObject = new VendorAddressBLL();
        ...
        public ActionResult Index()
        {
            ...
            setViewData();
            List<VendorAddressMdl> modelObject = new List<VendorAddressMdl> { };
        ...
        public ActionResult CreateUpdate(int id = 0)
        {
            ...
            VendorAddressMdl modelObject = new VendorAddressMdl();
            if (id != 0)
            {
        ...
        // POST: /CreateUpdate
        [HttpPost]
        public ActionResult CreateUpdate(VendorAddressMdl modelObject)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (modelObject.VendorAddId == 0)//add mode
                {
                    if (mc.getPermission(Entry.VendorEntry, permissionType.Add) == false)
                    {
                        return View();
        ...
        public ActionResult Details(int id = 0)
        {
            ...
            setViewData();
            VendorAddressMdl modelObject = bllObject.searchObject(id);
            if (modelObject == null)
            {
                return HttpNotFound();
            }
