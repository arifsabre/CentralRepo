...
{
    public class PendingPaymentToVendorReportController : Controller
    {
        ...
        [HttpPost]
        public ActionResult DisplayPendingPaymentToVendorReport(rptOptionMdl rptOption)
        {
            //[100162]
            if (objCookie.checkSessionState() == false) { return RedirectToAction("LoginUser", "Login"); };
            setViewData();
            ...
            {
                string reporturl = "PendingPaymentToVendorReport/getPendingPaymentToVendorReport";
            ...
            return RedirectToAction("getPendingPaymentToVendorReport", new { dtfrom = rptOption.DateFrom, dtto = rptOption.DateTo, compcode = rptOption.CompCode });
        }

        [HttpGet]
        public FileResult getPendingPaymentToVendorReport(DateTime dtfrom, DateTime dtto, int compcode)
        {
            //[100162]
            ...
            rptDoc.Load(System.IO.Path.Combine(Server.MapPath("~/Reports"), "PendingPaymentToVendorRpt.rpt"));
            setLoginInfo(rptDoc);
            //
            ...
            txtrpthead.Text = "Purchase Date From: " + mc.getStringByDate(dtfrom) + " To " + mc.getStringByDate(dtto);
