...
{
    public class DelayedSupplyReportController : Controller
    {
        ...
        #region delayed supply report

        [HttpPost]
        public ActionResult DelayedSupplyRpt(rptOptionMdl rptOption)
        {
            //[100003]
            if (objCookie.checkSessionState() == false) { return RedirectToAction("LoginUser", "Login"); };
            setViewData();
            ...
            {
                string reporturl = "DelayedSupplyReport/getDelayedSupplyReport";
            ...
            return RedirectToAction("getDelayedSupplyReport", new { dtfrom = rptOption.DateFrom, dtto = rptOption.DateTo, potype=rptOption.POType });
        }

        [HttpGet]
        public FileResult getDelayedSupplyReport(DateTime dtfrom, DateTime dtto, string potype)
        {
            //[100003]
            ...
            rptDoc.Load(System.IO.Path.Combine(Server.MapPath("~/Reports"), "DelayedSupplyRpt.rpt"));//TestXCrystalReport1
