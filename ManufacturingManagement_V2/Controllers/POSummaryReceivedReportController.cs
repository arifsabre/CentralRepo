...
{
    public class POSummaryReceivedReportController : Controller
    {
        ...
        [HttpPost]
        public ActionResult DisplayReceivedPOSummaryReport(rptOptionMdl rptOption)
        {
            //[100168]
            if (objCookie.checkSessionState() == false) { return RedirectToAction("LoginUser", "Login"); };
            setViewData();
            ...
            {
                string reporturl = "PendingPaymentReport/getReceivedPOSummaryReport";
            ...
            return RedirectToAction("getReceivedPOSummaryReport", new { potype = rptOption.POType, dtfrom = rptOption.DateFrom, dtto = rptOption.DateTo, compcode = rptOption.CompCode });
        }

        [HttpGet]
        public FileResult getReceivedPOSummaryReport(string potype, DateTime dtfrom, DateTime dtto, int compcode)
        {
            //[100168]
            ...
            rptDoc.Load(System.IO.Path.Combine(Server.MapPath("~/Reports"), "POSummaryReceivedRpt.rpt"));
            setLoginInfo(rptDoc);
            //
