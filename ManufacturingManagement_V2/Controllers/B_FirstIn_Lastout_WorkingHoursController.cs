...
{
    public class B_FirstIn_Lastout_WorkingHoursController : Controller
    {
        ...
        [HttpPost]
        public ActionResult Get_B_FirstInLastoutWorkingHours(rptOptionMdl rptOption)
        {
            //[100136]
            if (objCookie.checkSessionState() == false) { return RedirectToAction("LoginUser", "Login"); };
            setViewData();
            ...
            {
                string reporturl = "B_FirstIn_Lastout_WorkingHours/Get_B_FirstIn_Lastout_WithMissing_File";
            ...
            return RedirectToAction("Get_B_FirstIn_Lastout_WithMissing_File", new { dtfrom = rptOption.DateFrom, dtto = rptOption.DateTo, compcode = rptOption.CompCode, grade = rptOption.Grade });
        }
        public ActionResult Get_B_FirstIn_Lastout_WithMissing_File(DateTime dtfrom, DateTime dtto, int compcode, string grade)
        {
            //[100136]
            ...
            rptDoc.Load(System.IO.Path.Combine(Server.MapPath("~/Reports"), "B_FirstIn_Lastout_WorkingHours.rpt"));//TestXCrystalReport1
            setLoginInfo(rptDoc);
