...
{
    public class BillPaymentToVendorReportController : Controller
    {
        ...
        #region pending payment to vendor report

        [HttpPost]
        public ActionResult DisplayBillPaymentToVendorReport(rptOptionMdl rptOption)
        {
            //[100163]
            if (objCookie.checkSessionState() == false) { return RedirectToAction("LoginUser", "Login"); };
            setViewData();
            ...
            {
                string reporturl = "BillPaymentToVendorReport/getBillPaymentToVendorReport";
            ...
            return RedirectToAction("getBillPaymentToVendorReport", new { dtfrom = rptOption.DateFrom, dtto = rptOption.DateTo, compcode = rptOption.CompCode });
        }

        [HttpGet]
        public FileResult getBillPaymentToVendorReport(DateTime dtfrom, DateTime dtto, int compcode)
        {
            //[100163]
            ...
            rptDoc.Load(System.IO.Path.Combine(Server.MapPath("~/Reports"), "BillPaymentToVendorRpt.rpt"));
            setLoginInfo(rptDoc);
            //
            ...
            txtrpthead.Text = "Payment Date From: " + mc.getStringByDate(dtfrom) + " To " + mc.getStringByDate(dtto);
