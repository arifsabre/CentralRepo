...
{
    public class DBCBookRptBLL : DbContext
    {
        //
        ...
        //
        internal void prepareBookReport(reportName rptname, int ccode, string accode, DateTime dtfrom, DateTime dtto, DataTable dtrpt, bool printvtpvno, bool printnarr, string finyear)
        {
            ...
            for (int x = 0; x < nod; x++)
            {
                ...
                for (int i = 0; i < dttemprpt.Rows.Count; i++)
                {
                    ...
                    if (printvtpvno == true && printnarr == true)//case 11
                    {
                        ...
                        {
                            particulars = particulars + "\r\n" + "<" + dttemprpt.Rows[i]["crvtype"].ToString() + dttemprpt.Rows[i]["crvno"].ToString() + ">";
                        }
                        if (dttemprpt.Rows[i]["crnarr"].ToString() != "")
                        {
                            particulars = particulars + "\r\n" + "(" + dttemprpt.Rows[i]["crnarr"].ToString() + ")";
                        }
                    }
                    ...
                    if (printvtpvno == true && printnarr == true)//case 11
                    {
                        ...
                        {
                            particulars = particulars + "\r\n" + "<" + dttemprpt.Rows[i]["drvtype"].ToString() + dttemprpt.Rows[i]["drvno"].ToString() + ">";
                        }
                        if (dttemprpt.Rows[i]["drnarr"].ToString() != "")
                        {
                            particulars = particulars + "\r\n" + "(" + dttemprpt.Rows[i]["drnarr"].ToString() + ")";
                        }
                    }
                    else if (printvtpvno == false && printnarr == true)//case 01
                    {
